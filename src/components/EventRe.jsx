...
const EventRe = ({ event }) => {
  return (
    <div className="relative mx-auto scale-90 sm:scale-95  w-[19.6rem] ">
        ...
        />
      <div
        className="bg-[#D9D9D9] p-5 flex flex-col   text-center relative w-[19.6rem] h-[18rem]"
        style={{
          clipPath: "polygon(0 0, calc(100% - 20px) 0, 100% 20px, 100% 100%, 0% 100%)",
        }}
      >
        <h1 className="font-orbitron uppercase  text-xl font-bold leading-6 tracking-wide text-black">
          {event.name}
        </h1>
        <h2 className="font-orbitron text-xl font-kindle tracking-widest font-bold italic text-white mt-1 bg-black p-2">
          {event.clubName}
        </h2>
