...
export default function Guests() {
  return (
    <>
    <p className="text-center font-tech font-extrabold text-[2rem] bg-[#131313] text-white">OUR GUESTS</p>
      <div className="relative   h-max md:h-screen z-10 overflow-clip w-full flex bg-[#131313] flex-col sm:justify-center items-center md:grid sm:grid-cols-3">
